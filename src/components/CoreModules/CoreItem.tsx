    ...
    <div className='grid grid-cols-2 gap-[64px]'>
      <div className='col-span-2 lg:col-span-1 flex flex-col gap-y-4 justify-center'>
        <div className='flex items-center justify-center gap-x-5'>
          ...
          <span
            className={`text-base lg:text-[28px] text-center lg:text-left font-semibold text-gradient-${index}`}
          >
            {label}
          </span>
          <div className={`${bgGradientClass} w-[42px] h-[2px]`} />
        </div>
        <div className='text-neutral-6 text-sm lg:text-base text-center lg:text-left'>{description}</div>
      </div>
      <div
        className={cx('col-span-2 lg:col-span-1 flex justify-center items-center lg:justify-start lg:items-start', {
